...
void patchesExclude()
{
    ...
    pInput patchInput[26]{};
        ...
        std::cin >> patchInput->p[1];
        ignoreLine();

        if (patchInput->p[1] == 'e' || patchInput->p[1] == 'E')
        ...
        if (patchInput->p[6] == 'i' || patchInput->p[6] == 'I')
...
void ytmPatchesExclude()
{
    ...
    if (input == 'y' || input == 'Y')
    {
        ...
        std::cin >> ytmPatches->pMusic[2];
        ignoreLine();

        if (ytmPatches->pMusic[2] == 'e' || ytmPatches->pMusic[2] == 'E')
